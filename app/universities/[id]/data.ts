...
export const tourStops = [
  {
    ...
    thumbnail: "https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3"
  },
  {
    id: 2,
    title: "Engineering Complex",
    description: "Tour our state-of-the-art engineering facilities and laboratories",
    videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    thumbnail: "https://images.unsplash.com/photo-1581092921461-eab62e97a780?ixlib=rb-4.0.3"
  },
  {
    id: 3,
    ...
    videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    thumbnail: "https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-4.0.3"
  },
  {
    id: 4,
    ...
    videoUrl: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",
    thumbnail: "https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3"
  }
];
...
export const reviews = [
  {
    ...
    rating: 5,
    date: "March 15, 2024",
    content: "The quality of education and research opportunities here are exceptional. The professors are highly knowledgeable and always willing to help. The international student community is very welcoming.",
    likes: 45,
    replies: 12,
    verified: true
  },
  {
    ...
    rating: 4,
    date: "March 10, 2024",
    content: "Great university with excellent facilities. The career support services are particularly helpful. Only downside is the crowded cafeteria during peak hours.",
    likes: 32,
    replies: 8,
    verified: true
  },
  {
    ...
    rating: 5,
    date: "March 5, 2024",
    content: "The architecture program is world-class. The blend of traditional and modern approaches in teaching is unique. The studio facilities are outstanding.",
    likes: 56,
    replies: 15,
    verified: true
  },
  {
    ...
    content: "Good academic program but some facilities need updating. The research equipment in some labs is a bit outdated. However, the faculty is excellent.",
    likes: 18,
    replies: 6,
    verified: true
  },
  {
    ...
    content: "Amazing international atmosphere. The diversity of students and cultural exchange opportunities are incredible. The campus location is perfect for exploring the city.",
    likes: 41,
    replies: 9,
    verified: true
  }
...
export const universities = [
  {
    ...
    programs: [
      ...
      },
      {
        ...
        degree: 'Bachelor of Science',
        language: 'English',
        description: 'Learn to design and construct infrastructure projects with cutting-edge technology.',
        careers: ['Structural Engineer', 'Project Manager', 'Construction Manager'],
        courses: [
          'Structural Analysis',
      ...
      },
      {
        ...
        language: 'English',
        description: 'Blend creativity with technical expertise in architectural design and urban planning.',
      ...
      },
      {
        ...
        careers: ['Industrial Engineer', 'Operations Manager', 'Quality Engineer'],
        courses: [
          'Operations Research',
          'Quality Management',
    ...
    events: [
      {
        ...
        description: 'Join us for a comprehensive virtual tour and information session about our programs.',
      ...
      },
      {
        ...
        description: 'Hands-on workshop showcasing our engineering facilities and research projects.',
      ...
      },
      {
        ...
        description: 'Experience our campus life with a guided tour of our facilities.',
    ...
    facilities: [
      {
        ...
        image: 'https://images.unsplash.com/photo-1581092921461-eab62e97a780?ixlib=rb-4.0.3',
        features: ['Advanced Equipment', '24/7 Access', 'Technical Support']
      },
      {
        name: 'Library',
        description: 'Modern library with extensive digital and physical collections',
        image: 'https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-4.0.3',
        features: ['24/7 Study Areas', 'Digital Resources', 'Group Study Rooms']
      },
      {
        name: 'Sports Complex',
    ...
    testimonials: [
      {
        ...
        program: 'Computer Engineering',
        year: '2023',
        quote: 'The international exposure and quality of education here prepared me perfectly for my global career.',
      ...
      },
      {
        ...
        year: '2022',
        quote: 'The practical experience and industry connections helped me secure my dream job.',
      ...
      },
      {
        ...
        program: 'Architecture',
        year: '2023',
        quote: 'The blend of traditional and modern approaches in architecture education is unique.',
    ...
    researchCenters: [
      ...
      },
      {
        ...
        description: 'Research focused on environmental sustainability and renewable energy',
      ...
      },
      {
        ...
        projects: ['Industry 4.0', 'IoT Applications', 'Digital Transformation'],
        publications: 100
      }
    ],
    admissionStats: {
    ...
    housingOptions: [
      ...
      },
      {
        type: 'Homestay',
        cost: '$400/month',
        features: ['Cultural Experience', 'Meals Included', 'Family Environment'],
        availability: 'Available'
      }
    ],
    studentServices: [
