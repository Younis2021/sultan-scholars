...
import { universities, reviews, reviewStats, tourStops } from './data';
...
const applicationSteps = [
  ...
  },
  {
    ...
    description: "Gather all necessary documents including transcripts, diplomas, language certificates, and identification documents."
  },
  {
    title: "Complete Online Application",
    description: "Fill out the online application form with your personal information, academic history, and program preferences."
  },
  {
    title: "Pay Application Fee",
    description: "Submit the non-refundable application fee to process your application."
  },
  {
    title: "Track Application Status",
    description: "Monitor your application status through our online portal and respond to any additional requests."
  },
  {
    title: "Receive Admission Decision",
    description: "Admission decisions are typically made within 4-6 weeks after the application deadline."
  }
];

export default function UniversityPage({ params }: { params: { id: string } }) {
  const university = universities.find(u => u.id === params.id) || universities[0];
        ...
        <div className="container mx-auto px-4">
          <Tabs defaultValue="overview" className="space-y-8">
            ...
            <TabsContent value="apply">
              <ApplyTab university={university} applicationSteps={applicationSteps} />
            </TabsContent>
          </Tabs>
        </div>
      </section>
      ...
      <Dialog open={showContact} onOpenChange={setShowContact}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Our education advisors will contact you to discuss your options at {university.name}.
            </DialogDescription>
          </DialogHeader>
      ...
      <Dialog open={showBrochure} onOpenChange={setShowBrochure}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Get detailed information about programs, facilities, and admission requirements.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={(e) => { e.preventDefault(); handleDownloadBrochure(); }} className="space-y-4 py-4">
            <div className="space-y-2">
              <label className="text-sm font-medium">Full Name</label>
              <Input 
                placeholder="Your full name"
            ...
            <div className="pt-4 flex justify-end gap-2">
              <Button type="button" variant="outline" onClick={() => setShowBrochure(false)}>
                Cancel
              </Button>
              <Button type="submit" className="gradient-bg">
                Download Now
          ...
          <div className="py-6">
            <div className="bg-green-50 p-4 rounded-lg mb-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-medium mb-1">WhatsApp Education Advisor</h3>
                  <p className="text-sm text-muted-foreground mb-2">
                    Our advisors are available Monday-Friday, 9:00 AM - 6:00 PM (GMT+3)
                  </p>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4 turkish-title">Join Us at {university.name}</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Connect with our representatives and learn more about the university through these special events.
            </p>
          </motion.div>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4 turkish-title">Financial Support Options</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
                ...
                <Card className="overflow-hidden hover:shadow-xl transition-all duration-300">
                  <div className="p-6">
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <Badge className="gradient-bg text-white">{scholarship.amount}</Badge>
                    </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4 turkish-title">We're Here For You</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Comprehensive support services to ensure your success throughout your academic journey.
            </p>
          </motion.div>
                ...
                <Card className="p-6 hover:shadow-md transition-all duration-300">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <Button variant="link" className="p-0 h-auto text-primary hover-bounce">
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <h2 className="text-3xl font-bold mb-4 turkish-title">Life at {university.name}</h2>
            <p className="text-muted-foreground max-w-2xl mx-auto">
...
const upcomingEvents = [
  {
    ...
    location: "Online",
    description: "Join our virtual campus tour and information session to learn about programs, admission requirements, and student life."
  },
  {
    ...
    location: "Online",
    description: "Get hands-on guidance for completing your application, preparing documents, and maximizing your chances of acceptance."
  },
  {
    ...
    location: "Online",
    description: "Connect with successful graduates who will share their experiences and answer your questions about studying at our university."
  }
];
...
const scholarships = [
  {
    ...
    eligibility: "GPA 3.8+",
    description: "Awarded to exceptional students with outstanding academic achievements and demonstrated leadership potential."
  },
  {
    ...
    description: "Designed to support international students with strong academic backgrounds and financial need."
  },
  {
    ...
    description: "For graduate students interested in conducting research in priority areas with faculty mentorship."
  }
];
...
const supportServices = [
  {
    ...
    description: "Our dedicated team assists with student visa applications, residence permits, and all immigration-related matters.",
    icon: FileCheck
  },
  {
    title: "Accommodation Services",
    description: "We help you find comfortable and affordable housing options, both on-campus and in the surrounding areas.",
    icon: Building2
  },
  {
    title: "Academic Advising",
    description: "Personalized guidance to help you select courses, meet degree requirements, and achieve your academic goals.",
    icon: BookOpen
  },
  {
    title: "Career Development",
    description: "Comprehensive career services including resume workshops, interview preparation, and job placement assistance.",
    icon: Rocket
  }
];
...
const studentLifeHighlights = [
  ...
  },
  {
    ...
    description: "Stay active with state-of-the-art sports facilities, competitive teams, and recreational activities for all levels.",
  ...
  },
  {
    ...
    description: "Experience the vibrant culture, cuisine, and attractions of the city with organized trips and student discounts.",
    image: "https://images.unsplash.com/photo-1527838832700-5059252407fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1350&q=80",
